...
#### Scenario: Empty Python path
- GIVEN Settings Python path is empty
- WHEN splash, audit, editor, and tuner run
- THEN no critical path fails for lack of Python
- AND the optional path is stored if the operator later pastes `python.exe`
